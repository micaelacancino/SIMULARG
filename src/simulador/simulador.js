...
export async function Simulador(resultado, dias = 60) {
  ...
  while (dia <= dias) {
    ...
    resultado.push({
      ...
      N: contadores.N,
      CNR: contadores.CNR,
      CNRA: contadores.CNRA,
      PC: contadores.PC,
      CPCR: contadores.CPCR,
      CPCRA: contadores.CPCRA,
      F: contadores.F,
      CFR: contadores.CFR,
      CFRA: contadores.CFRA,
      M: contadores.M,
      CMR: contadores.CMR,
      CMRA: contadores.CMRA,
      R: contadores.R,
      CRR: contadores.CRR,
      CRRA: contadores.CRRA,
      CPU: contadores.CPU,
      CCPUR: contadores.CCPUR,
      CCPURA: contadores.CCPURA,
      GPU: contadores.GPU,
      CGPUR: contadores.CGPUR,
      CGPURA: contadores.CGPURA,
      ER: contadores.ER,
      ERA: contadores.ERA,
      TR: contadores.TR,
      TRA: contadores.TRA,
